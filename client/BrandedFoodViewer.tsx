...
export const BrandedFoodViewerView: React.SFC<BrandedFood> = (props) => {
...
function mapStateToProps(state: RootState): BrandedFood {
  return state.food as BrandedFood;
}

export const BrandedFoodViewer = connect(mapStateToProps)(BrandedFoodViewerView);